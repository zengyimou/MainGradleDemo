...
class EncryptStringsPlugin : Plugin<Project> {
        ...
        project.afterEvaluate {
            ...
            if (androidExtension is BaseExtension) {
                androidExtension.buildTypes.forEach { buildType ->
                    ...
                    project.logger.lifecycle("Encrypting strings for $buildTypeName")
                    ...
                    project.logger.lifecycle("Encrypted strings written to ${targetFile.path}")
                }
            }
        }
    }
